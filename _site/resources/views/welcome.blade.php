...
<div class="container text-center pad_con">
    ...
    <p data-wow-delay="1.3s" class = "wow animated bounceInRight">A <b>charitable organization</b> or <b>charity</b> is a non-profit organization (NPO) whose primary objectives are philanthropy and social well-being (e.g. charitable, educational, religious, or other activities serving the public interest or common good).</p>
    <p data-wow-delay="1.6s" class = "wow animated bounceInLeft">  The legal definition of a charitable organisation (and of charity) varies between countries and in some instances regions of the country. The regulation, the tax treatment, and the way in which charity law affects charitable organizations also vary.</p>
    <p data-wow-delay="1.6s" class = "wow animated bounceInRight">   Financial figures (e.g. tax refund, revenue from fundraising, revenue from sale of goods and services or revenue from investment) are important indicators to assess the financial sustainability of a charity, especially to charity evaluators. This information can impact a charity's reputation with donors and societies, and thus the charity's financial gains. </p>
    <p data-wow-delay="1.6s" class = "wow animated bounceInLeft">  Charitable organisations often depend partly on donations from businesses. Such donations to charitable organisations represent a major form of corporate philanthropy.</p>
    <br>
    <br>
