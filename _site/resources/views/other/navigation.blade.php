            ...
            <ul class="navbar-nav ml-auto">
                @if (Route::has('login'))
                    <li class="top-right links">
                        @auth
                            @if (Request::is('fund/*'))) <a href="{!! url('/logout') !!}"><button class = "btn btn-primary"> Main Page </button></a> @endif
                        ...
                        @else
                            @if (Request::is('fund/*'))) <a href="{!! url('/logout') !!}"><button class = "btn btn-success"> Main Page </button></a> @endif
